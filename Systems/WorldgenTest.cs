...
public class WorldGenTutorialWorld : ModSystem
{
    ...
    private void TestMethod(int x, int y)
    {
        ...
        var direction = Main.LocalPlayer.Center.DirectionTo(Main.MouseWorld);
        var playerCenter = Main.LocalPlayer.Center.ToTileCoordinates();
        var cursorCenter = Main.MouseWorld.ToTileCoordinates();
    }
}