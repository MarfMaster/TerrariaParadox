...
public class AssecstoneRubble1x2HangingNatural : ModdedRubbleNatural
{
	public const int GrowChance = 80;
	public override string TexturePath => "TerrariaParadox/Content/Tiles/Misc/AssecstoneRubble1x2Hanging";
...
public class AssecstoneRubble1x2HangingFake : ModdedRubbleFake
{
	public override string TexturePath => "TerrariaParadox/Content/Tiles/Misc/AssecstoneRubble1x2Hanging";
	public override int OnMineDustType => ModContent.DustType<AssecstoneDust>();
	public override TileObjectData TileStyle => TileObjectData.Style1x2Top;
