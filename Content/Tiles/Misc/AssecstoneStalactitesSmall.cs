...
public class AssecstoneStalactitesSmallNatural : ModdedRubbleNatural
{
    public const int GrowChance = 100;
    public override string TexturePath => "TerrariaParadox/Content/Tiles/Misc/AssecstoneStalactitesSmall";
...
public class AssecstoneStalactitesSmallFake : ModdedRubbleFake
{
    public override string TexturePath => "TerrariaParadox/Content/Tiles/Misc/AssecstoneStalactitesSmall";
    public override int OnMineDustType => ModContent.DustType<AssecstoneDust>();
    public override TileObjectData TileStyle => TileObjectData.Style1x1;
