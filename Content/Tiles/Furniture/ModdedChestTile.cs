...
using TerrariaParadox.Content.Items.Consumables;
...
namespace TerrariaParadox.Content.Tiles.Furniture;
	...
	public abstract class ModdedChestTile : ModTile
	{
		...
		*/
		...
		/// <summary>
		/// Adds a condition for locking the chest while it is unlocked. An example could be placing a lock on the chest, or checking whether a boss has been defeated yet.
		/// </summary>
