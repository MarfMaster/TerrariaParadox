...
public class Sapling : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.AnchorValidTiles =
            [ModContent.TileType<FlippedGrassBlock>(), ModContent.TileType<AssecsandBlockTile>()];
    ...
    public override void RandomUpdate(int i, int j)
    {
        ...
        if (!WorldGen.genRand.NextBool(20)) return;

        var tile = Framing.GetTileSafely(i, j); // Safely get the tile at the given coordinates
        ...
        if (growSuccess && isPlayerNear) WorldGen.TreeGrowFXCheck(i, j);
    }
